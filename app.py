...
<style>
    ...
    p {{ text-align: center !important; font-size: 1.1rem; color: #333333 !important; }}
    
    div[data-testid="stButton"] button[kind="primary"] {{
        background-color: #77d4d4 !important; border: none !important;
...
with col_cen:
    ...
    if st.session_state.si:
        ...
        titolo = "Vuoi essere il mio San Valentino?🌹"
        if st.session_state.pos_top is not None:
